export default function Curvy({width=100, height=100, horizontalFlip=false, verticalFlip=false, curvyColor='#ffffff'}) {
	...
	return (
		<div style={{ width:"100%", height:`${height}px` ,overflow: "hidden" }}>
			<div style={{  
			transform: `scaleX(${horizontalFlip ? -1 : 1}) scaleY(${verticalFlip ? -1 : 1}) rotate(${verticalFlip ? "180deg" : 0})` }}>	
				<svg
